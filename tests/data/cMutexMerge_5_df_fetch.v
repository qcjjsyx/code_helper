...
//@cc: name: cMutexMerge_5_df_fetch
...
module cMutexMerge_5_df_fetch#(
    parameter DATA_WIDTH = 81
)(
    input  wire                    i_drive0, i_drive1, i_drive2,i_drive3,i_drive4,
    input  wire [DATA_WIDTH-1:0]  i_data0,  i_data1,  i_data2,i_data3,i_data4,
    input  wire                    i_freeNext,
    input  wire                    rst,

    output wire                    o_free0, o_free1, o_free2,o_free3,o_free4,
    ...
    wire [N-1:0] i_drive = {i_drive4,i_drive3,i_drive2, i_drive1, i_drive0};
