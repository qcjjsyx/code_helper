...
(* dont_touch="true" *) delay8U cFifo1_1Delay0(.inR(w_fire_6[0]), .outR(w_grfDriveToLaunch_1), .rst(rst)); 
(* dont_touch="true" *) delay8U cFifo1_1Delay1(.inR(w_grfDriveToLaunch_1), .outR(o_grfDriveToLaunch_1), .rst(rst)); 
