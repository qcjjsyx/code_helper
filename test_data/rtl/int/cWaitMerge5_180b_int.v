...
(* dont_touch="true" *)delay4U outdelay3 (.inR(i_drive3), .outR(w_drive3Next), .rst(rst));
contTap forthTap(
.trig(w_forthTrig),
.req(w_forthReq),
.rst(rst)
...
(* dont_touch="true" *)delay4U outdelay4 (.inR(i_drive4), .outR(w_drive4Next), .rst(rst));
contTap fifthTap(
.trig(w_fifthTrig),
.req(w_fifthReq),
.rst(rst)
...
assign w_driveNext = w_drive0Next | w_drive1Next | w_drive2Next | w_drive3Next;
assign w_sendDrive = w_driveNext & w_secondReq & w_firstReq & w_forthReq & w_thirdReq;
...
assign o_data_180 = {w_data0_36[35:32],w_data1_36[35:32], w_data2_36[35:32], w_data3_36[35:32], 4'b1111,w_data0_36[31:0] ,w_data1_36[31:0], w_data2_36[31:0], w_data3_36[31:0], w_data4_36[31:0]};
