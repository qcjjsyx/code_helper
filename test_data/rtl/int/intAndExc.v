...
(* dont_touch="true" *) cWaitMerge5_180b_int cmpMerge(.i_drive0(i_intDriveFromIF), .i_data0_36({r_intNum_4,w_decPC_32}), .o_free0(o_intFreeToIF),
...
reg [1:0] r_DRValid_2;
wire w_SRDriveDelay_1;
(* dont_touch="true" *)delay8U SRDriveDelay(
  .inR(w_SRDrive_1),
  .outR(w_SRDriveDelay_1),
  .rst(rst)
  );
// assign w_en_DRValid = w_vecSpliDriToWbMer_1 | w_SRDrive_1;
assign w_en_DRValid = w_vecSpliDriToWbMer_1 | w_SRDriveDelay_1;
//3/16 zwm add a contap
wire w_SRDriveReq_1;
contTap SRDriveTap(
.trig(w_SRDrive_1 | w_SRDriveDelay_1),
.req(w_SRDriveReq_1),
.rst(rst)
); 
//出入栈选择
