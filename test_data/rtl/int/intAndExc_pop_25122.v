...
// assign w_grfAddr_8 = (r_outNum_2 == 2'b00)? {4'd12, 4'd14}: // R12, LR?
...
//                      (r_outNum_2 == 2'b01)? {4'd2,  4'd3 }: // R2, R3
//                      (r_outNum_2 == 2'b10)? {4'd12, 4'd14 }: // R12, LR
//                                              8'b0;
assign w_grfAddr_8 = (r_outNum_2 == 2'b00)? {4'd1,  4'd0}: // R0, 1?
                     (r_outNum_2 == 2'b01)? {4'd3,  4'd2 }: // R2, R3
                     (r_outNum_2 == 2'b10)? {4'd14, 4'd12 }: // R12, LR
                                             8'b0;
                                             
// 去往写寄存器的择路
    
wire w_drive0Delay,w_drive0Delay1;
reg r_GPvalid_1;
reg [7:0] r_grfAddr_8;
reg [63:0] r_DRdata_64;
(* dont_touch="true" *) delay6U Delay0(.inR(w_drive0), .outR(w_drive0Delay), .rst(rst));
(* dont_touch="true" *) delay8U Delay1(.inR(w_drive0Delay), .outR(w_drive0Delay1), .rst(rst));
always @(posedge w_drive0Delay or negedge rst) begin
    if (!rst) begin
        r_GPvalid_1 <= 1'b0;
        r_grfAddr_8 <= 8'b0;
        r_DRdata_64 <= 64'b0;
    end else begin
        r_GPvalid_1 <= w_GPvalid_1;
        r_grfAddr_8 <= w_grfAddr_8;
        r_DRdata_64 <= i_DRdata_64;
    end
end
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)
cSelector2_73b_intAndExc_pop  u0_cSelector2_73b_intAndExc_pop (
    .i_drive                 ( w_drive0Delay1    ),
    .i_freeNext0             ( i_freeFromWGRF    ),
    .i_freeNext1             ( i_freeFromWPSR    ),
    .rst                     ( rst               ),
    // .i_data_73               ( {w_GPvalid_1, w_grfAddr_8, i_DRdata_64} ),
    .i_data_73               ( {r_GPvalid_1, r_grfAddr_8, r_DRdata_64} ),
