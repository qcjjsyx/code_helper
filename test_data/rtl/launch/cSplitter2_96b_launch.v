/*=============================================================
Project:ARMCPU
Module:cSplitter2_96b_launch
Author:zlt
Mail:zlt22@lzu.edu.cn
Date:2024/xx/xx
Description:cSplitter2_96b_launch of launch
==============================================================*/

`timescale 1ns / 1ps

module cSplitter2_96b_launch(
i_drive, i_data_96, o_free,
...
assign o_data0_32 = i_data_96[95:64];
assign o_data1_64 = i_data_96[63:0];
