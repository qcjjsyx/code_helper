/*=============================================================
Project:ARMCPU
Module:cSelector2_17b_launch
Author:zlt
Mail:zlt22@lzu.edu.cn
Date:2024/xx/xx
Description:cSelector2_17b_launch of launch
==============================================================*/

`timescale 1ns / 1ps

module cSelector2_17b_launch(
i_drive, i_data_17, o_free,
...
always @(posedge w_fire or negedge rst) begin
	if (!rst) begin
		...
		r_data0_8 <= i_data_17[7:0];
		r_data1_8 <= i_data_17[15:8];
		r_valid_1 <= w_valid_1;
	end
end

assign o_data0_8 = r_data0_8 & {8{~r_valid_1}};
assign o_data1_8 = r_data1_8 & {8{r_valid_1}};
