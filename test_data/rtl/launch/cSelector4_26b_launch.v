/*=============================================================
Project:ARMCPU
Module:cSelector4_26b_launch
Author:zlt
Mail:zlt22@lzu.edu.cn
Date:2024/xx/xx
Description:cSelector4_26b_launch of launch
==============================================================*/
...
module cSelector4_26b_launch(
i_drive, i_data_26, o_free,
o_driveNext0, i_freeNext0, o_data0_24,
o_driveNext1, o_data1_24, i_freeNext1,
o_driveNext2, i_freeNext2, o_data2_24,
o_driveNext3, o_data3_24, i_freeNext3,
rst);

input i_drive;
input i_freeNext0,i_freeNext1,i_freeNext2,i_freeNext3;
input rst;
input [25:0] i_data_26;

output o_free;
output o_driveNext0,o_driveNext1,o_driveNext2,o_driveNext3;
output [23:0] o_data0_24;
output [23:0] o_data1_24; 
output [23:0] o_data2_24; 
output [23:0] o_data3_24; 
...
assign w_valid_2 = i_data_26[25:24];
...
always @(posedge w_fire or negedge rst) begin
	if (!rst) begin
		...
		r_data0_24 <= i_data_26[23:0];
		r_valid_2 <= w_valid_2;
	end
end

assign o_data0_24 = r_data0_24 & {24{~r_valid_2[1]}} & {24{~r_valid_2[0]}};
assign o_data1_24 = r_data0_24 & {24{~r_valid_2[1]}} & {24{r_valid_2[0]}};
assign o_data2_24 = r_data0_24 & {24{r_valid_2[1]}} & {24{~r_valid_2[0]}};
assign o_data3_24 = r_data0_24 & {24{r_valid_2[1]}} & {24{r_valid_2[0]}};
