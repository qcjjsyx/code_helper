...
assign w_inData0_64 = {32'h0000abcd, w_stackData_224[223:192]};//w_pc_32 固定为 32'h0000abcd
...
assign w_inData0Addr_32 = i_SP_32 - 8;// i_SP_32 固定为32'h0000ab30
...
(* dont_touch="true" *) cMutexMerge2_1b inStackMerge(.i_drive0(w_dataMerDriveToInMer_1), .i_data0_1(), .o_free0(w_freeFromInMer_1),
                        ...
                        .i_freeNext(i_freeFromDR_1), .o_driveNext(o_w_inStackDriToDR_1), .o_data_1(),
                        .rst(rst));
...
//                        .o_driveNext1(w_DRSeleDriToinStackSele_1), .i_freeNext1(1'b0), .o_data1_64(), //入栈不需要返回数据
