...
reg [31:0] r_lhwmMemAddr_32;
reg [63:0] r_lhwmTemp_64;
...
begin
    ...
    begin
         r_lhwmTemp_64  <= 64'b0;
        r_lhwmMemAddr_32 <= 32'h0000_0000;
	end
	else 
    begin
        r_lhwmMemAddr_32 <= i_data_96[95:64] + 32'h8;
	    r_lhwmTemp_64		<=	i_data_96[63:0];
	end
end
assign o_data_96 = {r_lhwmMemAddr_32,r_lhwmTemp_64};
