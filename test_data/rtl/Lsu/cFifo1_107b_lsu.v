...
module cFifo1_107b_lsu(
i_drive, i_data_107, o_free,rst,
o_driveNext, o_data_107, i_freeNext
);

input i_drive, i_freeNext, rst;
input [106:0] i_data_107;
output o_free, o_driveNext;
output [106:0] o_data_107;

wire [1:0] w_outRRelay_2,w_outARelay_2;
wire w_driveNext;
wire w_fire_1;

reg [106:0] r_data_107;
...
always @(posedge w_fire_1 or negedge rst) begin
	if (!rst) begin
		...
		r_data_107 = i_data_107;
	end
end

assign o_data_107 = r_data_107;
