`timescale 1ns / 1ps
module cMutexMerge2_76b_lsu(
i_drive0, i_data0_76, o_free0,
i_drive1, i_data1_76, o_free1,
i_freeNext, o_driveNext, o_data_76,
rst
);

//input & output port
input i_drive0, i_drive1;
input [75:0] i_data0_76, i_data1_76;
input i_freeNext;
input rst;

output o_free0, o_free1;
output o_driveNext;
output [75:0] o_data_76;
...
wire [75:0] w_data0_76,w_data1_76;
wire [75:0] w_data_76;
reg [75:0] r_data0_76,r_data1_76;
reg [75:0] r_data_76;
...
assign w_data_76 = (w_firstReq == 1'b1) ? i_data0_76 :
			((w_secondReq == 1'b1) ? i_data1_76 : 76'b0);
assign o_data_76 = w_data_76;
