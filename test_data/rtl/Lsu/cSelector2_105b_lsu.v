...
module cSelector2_105b_lsu(
i_drive, i_data_105, o_free,
...
always @(posedge w_fire or negedge rst) begin
	if (!rst) begin
		...
		r_data0_104 <= i_data_105[104:1];
		r_valid_1 <= w_valid_1;
	end
end

assign o_data0_104 = r_data0_104 	& {104{~r_valid_1}};
assign o_data1_104 = r_data0_104 	& {104{r_valid_1}};
