...
module cSplitter2_107_74_33b_lsu(
i_drive, i_data_107, o_free,
o_driveNext0, i_freeNext0, o_data0_74,
o_driveNext1, o_data1_33, i_freeNext1,
rst);

input i_drive;
input i_freeNext0,i_freeNext1;
input rst;
input [106:0] i_data_107;

output o_free;
output o_driveNext0,o_driveNext1;
output [73:0] o_data0_74;
output [32:0] o_data1_33;
...
assign o_data0_74 = i_data_107[73:0];
...
assign o_data1_33 = i_data_107[106:74];
