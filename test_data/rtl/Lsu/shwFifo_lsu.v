...
reg [31:0] r_shwMemAddr_32;
reg [63:0] r_shwMemData_64;
reg [7:0]  r_shwMemWen_8;
...
begin
	if(!rst) 
    begin
	    r_shwMemAddr_32	<= 32'h0000_0000;
        r_shwMemData_64 <= 64'h0000_0000_0000_0000;
	    r_shwMemWen_8	<= 8'b0000_0000;
	end
	else 
    begin
	    r_shwMemAddr_32	<= i_data_104[103:72];
        r_shwMemData_64 <= i_data_104[71:8];
	    r_shwMemWen_8   <=	8'b0000_0001;
	end
end

assign o_data_104 = {r_shwMemAddr_32,r_shwMemData_64,r_shwMemWen_8};
