...
reg [31:0] r_sIdleMemAddr_32;
reg [63:0] r_sIdleMemData_64;
reg [7:0]  r_sIdleMemWen_8;
//pipeline
sender sender(
	.i_drive(i_drive),
	.o_free(o_free),
...
begin
	if(!rst) 
    begin
	    r_sIdleMemAddr_32 = 32'h0000_0000;
        r_sIdleMemData_64 = 64'h0000_0000_0000_0000;
        r_sIdleMemWen_8   = 8'b0000_0000;
	end
	else 
    begin
	    r_sIdleMemAddr_32 = i_data_104[103:72];
        r_sIdleMemData_64 = i_data_104[71:8];
        r_sIdleMemWen_8   = i_data_104[7:0];

	end
end

assign o_data_104 = {r_sIdleMemAddr_32,r_sIdleMemData_64,r_sIdleMemWen_8};
