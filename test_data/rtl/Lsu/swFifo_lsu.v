...
reg [31:0] r_swMemAddr_32;
reg [63:0] r_swMemData_64;
reg [7:0]  r_swMemWen_8;
...
begin
	if(!rst) 
    begin
	    r_swMemAddr_32 <= 32'h0000_0000;
        r_swMemData_64 <= 64'h0000_0000_0000_0000;
        r_swMemWen_8   <= 8'b0000_0000;
	end
	else 
    begin
	    r_swMemAddr_32 <= i_data_104[103:72];
        r_swMemData_64 <= i_data_104[71:8];
        r_swMemWen_8   <= i_data_104[7:0];
	end
end

assign o_data_104 = {r_swMemAddr_32,r_swMemData_64,r_swMemWen_8};
