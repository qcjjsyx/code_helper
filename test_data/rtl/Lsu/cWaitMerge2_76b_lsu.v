...
module cWaitMerge2_76b_lsu(
i_drive0,i_data0_12,o_free0,
i_drive1,i_data1_64,o_free1,rst,
o_driveNext,o_data_76,i_freeNext
);

//input & output port
input i_drive0,i_drive1;
input [11:0] i_data0_12;
...
wire [11:0] w_data0_12;
wire [63:0] w_data1_64;

reg [11:0] r_data0_12;
reg [63:0] r_data1_64;

assign w_data0_12 = i_data0_12;
...
assign o_data_76 = {w_data1_64,w_data0_12};
