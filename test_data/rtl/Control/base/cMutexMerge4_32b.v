...
delay4U outdelay1(.inR(o_free1), .outR(w_freeDelay1), .rst(rst));
...
delay4U outdelay2(.inR(o_free2), .outR(w_freeDelay2), .rst(rst));
...
delay4U outdelay3(.inR(o_free3), .outR(w_freeDelay3), .rst(rst));
