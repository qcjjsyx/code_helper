...
//-----------------------------------------big change--------------------------------------------//
/*1/23 zwm 
由于有的时候i_launchDriveToExecute_1来的比i_executeFreeFromExcp_1快，需要加个fifo卡一�?
*/
wire w_launchDriveToExecute_1;
wire w_executeFreeToLaunch_1;
cFifo1 exeFifo2(.i_drive(i_launchDriveToExecute_1), .i_freeNext(i_executeFreeFromExcp_1), .rst(rst),
               .o_free(w_executeFreeToLaunch_1), .o_driveNext(w_launchDriveToExecute_1), .o_fire_1());


//----------------------------------------change end--------------------------------------------//
 (* dont_touch="true" *)cSplitter3_169_41_4_132b_exe executeSplitter(
.i_drive(w_launchDriveToExecute_1), .i_data_169(169'b0), .o_free(o_executeFreeToLaunch_1),
...
// wire w_addMutexMergeToAddFifoDelay3_1;
 (* dont_touch="true" *)delay8U delayDriveToAddFifo0(//zwm 2/20 change 6U to 8U
    .inR(w_addMutexMergeToAdd_1),
...
delay8U delayDriveToAlignFifo(//2/12 zwm change 1u to 8u
...
wire w_exeByPathDriveToLaunch_1;
wire [63:0] a;
wire [63:0] b;
//�����ɵ���·
...
.o_driveNext0(w_exeByPathDriveToLaunch_1), .i_freeNext0(i_executeFreeFromLaunchByPath_1), .o_data0_64(a),
...
(* dont_touch="true" *)delay8U exeToLaunchDataDelay1(
    .inR(w_exeByPathDriveToLaunch_1),
    .outR(o_exeByPathDriveToLaunch_1),
    .rst(rst)
    );
(* dont_touch="true" *)delay4U exeToLaunchDataDelay2(
    .inR(o_exeByPathDriveToLaunch_1),
    .outR(w_exeByPathDriveToLaunchDelay_1),
    .rst(rst)
    );
reg [63:0] r_resMutexMergeToFinalWaitMergeData_64;
always @(posedge w_exeByPathDriveToLaunchDelay_1 or negedge rst) begin
    if (!rst) begin
        r_resMutexMergeToFinalWaitMergeData_64 <= 64'b0;
    end else begin
        r_resMutexMergeToFinalWaitMergeData_64 <= w_resMutexMergeToFinalWaitMergeData_64;
    end
end
wire [3:0] w_nzcv_4;
wire w_n_1,w_z_1,w_C_1,w_v_1;
assign w_n_1 = r_resMutexMergeToFinalWaitMergeData_64[31];
assign w_z_1 = w_all64Flag_1 == 1'b1 ? (r_resMutexMergeToFinalWaitMergeData_64 == 64'b0) :(r_resMutexMergeToFinalWaitMergeData_64[31:0] == 32'b0);
...
assign o_exeToLaunchData_96= {w_nzcv_4,{28{1'b0}},r_resMutexMergeToFinalWaitMergeData_64};
...
cFifo1 exeFifo1(.i_drive(w_rescSplitterToFinalWaitMerge_1), .i_freeNext(finalWaitMergeToRescSplitter_1), .rst(rst),
               .o_free(exeFifo1ToRescSplitter_1), .o_driveNext(w_rescSplitterToFinalWaitMerge1_1), .o_fire_1(w_exeFifo1Fire_1));

wire [94:0] w_exeToLsuData_95;               
reg [94:0] r_exeToLsuData_95;
reg [67:0] r_exeToLsuData_68;
wire [67:0] w_exeToLsuData_68;
...
//2/7 zwm
always @(posedge w_rescSplitterToFinalWaitMerge1_1 or negedge rst) begin
    if(!rst)begin
        r_exeToLsuData_68 <= 68'b0;
    end else begin
        r_exeToLsuData_68 <= {w_nzcv_4,w_resMutexMergeToFinalWaitMergeData_64};
    end
end

assign w_exeToLsuData_95 = r_exeToLsuData_95;
assign w_exeToLsuData_68 = r_exeToLsuData_68;
wire w_executeDriveToLsu_1,w_executeFreeFromLsu_1;
wire w_rescSplitterToFinalWaitMerge1Delay_1;
delay8U finalWaitMergeDrv0Delay(.inR(w_rescSplitterToFinalWaitMerge1_1), .outR(w_rescSplitterToFinalWaitMerge1Delay_1), .rst(rst)); 
 (* dont_touch="true" *)cWaitMerge2_163b_exe finalWaitMerge(
.i_drive0(w_rescSplitterToFinalWaitMerge1Delay_1),.i_data0_68(w_exeToLsuData_68),.o_free0(finalWaitMergeToRescSplitter_1),
...
//     );
contTap executeTap(
    .trig(w_launchDriveToExecute_1 | i_executeFreeFromExcp_1),
    .req(o_executeInUseFlag_1),
    .rst(rst)
    );
