...
assign w_iFExcOrIntFlag_1 = (w_exceptionF_2_4 != 4'b1111 || w_intExcNum_4 != 4'b1111 || w_intNewType_6 != 6'b000000)
                         && (w_exeTrueNum_4==4'hf); 
...
(* dont_touch="true" *) delay8U exeByPathDelay(.inR(w_intDriToIntTmp), .outR(w_intDriToIntTmp1), .rst(rst)); 
assign w_launchToFetch_1 = w_intDriToIntTmp1 | w_driveToDec;//2/21 zwm change
always @(posedge w_launchToFetch_1 or negedge rst) begin
    if(!rst)begin
        r_releaseExeByPathFlag_1 = 1'b1;
    end else begin
        if(w_intDriToIntTmp1) begin
