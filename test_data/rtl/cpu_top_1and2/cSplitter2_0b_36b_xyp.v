//-----------------------------------------------
//	module name: cSplitter2_0b_36b_xyp
//	author: xing.yunpeng
//	version: 2024/12/23
//-----------------------------------------------
`timescale 1ns / 1ps

module cSplitter2_0b_36b_xyp(
...
// 		r_data1_8 <= 8'b0; 
// 	end else begin
// 		r_data0_8 <= i_data_36[7:0];
// 		r_data1_8 <= i_data_36[15:8];
// 	end
// end

// assign o_data0_8 = i_data_36[15:8];
assign o_data1_36 = i_data_36;
