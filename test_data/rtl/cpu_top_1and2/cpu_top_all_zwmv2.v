...
(* dont_touch="true" *) fetch fetch_inst (
    ...
    .o_drv2Excp_2(w_drv2Excp_2Tmp),.i_freeFExcp_2(w_freeFExcp_2),.o_exceptionF_2_4(w_exceptionF_2_4),
    .o_drv2Excp(w_iFExcdriToIntTmp), .i_freeFExcp(w_ifExcFreeFromIntTmp), .o_exceptionF_4(w_intExcNum_4),
...
assign w_launchToFetch_1 = w_intDriToIntTmp | w_driveToDec1;//2/21 zwm change
