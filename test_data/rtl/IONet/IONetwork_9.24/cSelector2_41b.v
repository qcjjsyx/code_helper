...
module cSelector2_41b(
i_drive, i_data_41, o_free,
o_driveNext0, i_freeNext0, o_data0_40,
o_driveNext1, o_data1_40, i_freeNext1,
rst);
...
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input [40:0] i_data_41;
...
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output [39:0] o_data0_40;
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output [39:0] o_data1_40; 
...
assign w_valid_1 = i_data_41[40];

(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [39:0] r_data0_40;
...
always @(posedge w_fire or negedge rst) begin
	if (!rst) begin
		...
		r_data0_40 <= i_data_41[39:0];
		r_valid_1 <= w_valid_1;
	end
end

assign o_data0_40 = r_data0_40 & {40{r_valid_1}};
assign o_data1_40 = r_data0_40 & {40{~r_valid_1}};
