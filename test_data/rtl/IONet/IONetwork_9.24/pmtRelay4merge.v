...
// Target Devices: 
// Tool Versions: 
// Description: pmtRelay used in merge
// 
// Dependencies: 
// 
// Revision:
...
module pmtRelay4merge(inR, inA, outR, outA, fire, pmt, rst); 
...
AN2M16HM andFire ( .A(inAR), .B(outAR), .Z(fire1) );
AN2M16HM pmtFire ( .A(pmt), .B(fire1), .Z(fire) );
