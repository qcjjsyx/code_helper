...
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [4:0]  w_outRRelay_5;
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [3:0]w_outARelay_4;
...
relay relay0_inst(
    .inR(w_outRRelay_5[0]),
    .inA(w_outARelay_4[0]),
    .outR(w_outRRelay_5[1]),
    .outA(w_outARelay_4[1]),
    .fire(o_fire_3[0]),
	.rst(rst)
);

delay2U outdelay1 (.inR(w_outRRelay_5[1]), .outR(w_outRRelay_5[4]), .rst(rst));

relay relay1_inst(
    .inR(w_outRRelay_5[4]),
    .inA(w_outARelay_4[1]),
    .outR(w_outRRelay_5[2]),
