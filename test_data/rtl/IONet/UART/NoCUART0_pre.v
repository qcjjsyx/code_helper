...
module NoCUART0(
    ...
    (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire NDVL,RXRDY,TXRDY;
   ...
   cFifo2 cfifo0(
    ...
    //-----------------第一第二个fifo之间加满80ns以上的延迟--------------//
    wire w_drv2fifo1_dalay1;
    wire w_drv2fifo1_dalay2;
    wire w_drv2fifo1_dalay3;
    wire w_drv2fifo1_dalay4;
    wire w_drv2fifo1_dalay5;
    wire w_drv2fifo1_dalay6;
    wire w_drv2fifo1_dalay7;
    delay64U delay1 (.inR(w_drv2fifo1), .outR(w_drv2fifo1_dalay1),.rst(rst));
    delay64U delay2 (.inR(w_drv2fifo1_dalay1), .outR(w_drv2fifo1_dalay2),.rst(rst));
    delay64U delay3 (.inR(w_drv2fifo1_dalay2), .outR(w_drv2fifo1_dalay3),.rst(rst));
    delay64U delay4 (.inR(w_drv2fifo1_dalay3), .outR(w_drv2fifo1_dalay4),.rst(rst));
    delay32U delay5 (.inR(w_drv2fifo1_dalay4), .outR(w_drv2fifo1_dalay5),.rst(rst));
    delay32U delay6 (.inR(w_drv2fifo1_dalay5), .outR(w_drv2fifo1_dalay6),.rst(rst));
    delay8U delay7 (.inR(w_drv2fifo1_dalay6), .outR(w_drv2fifo1_dalay7),.rst(rst));  
   
    //-----------------第二个fifo关闭读写过程----------------//
    wire  w_firefifo1,w_drv2Noc_delay,w_drv2Noc_delay1,w_drv2Noc_delay2;
    cFifo1 cfifo1(
    .i_drive        (w_drv2fifo1_dalay7 ),
    .o_free         (w_freeFfifo1       ),
