...
// 
// Create Date: 2025/03/26 09:51:01
// Design Name: 
// Module Name: wd2noc
// Project Name: 
// Target Devices: 
...
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg pluse,pluse_level,pluse_level_1,pluse_level_11;
(*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire rise;
always @(posedge i_drive or negedge Noc_RES) begin
    if(!Noc_RES) begin
  pluse  <= 1'b0;
    end else begin
  pluse  <= ~pluse;
...
always @(posedge wd_clk or negedge Noc_RES) begin
    if(!Noc_RES) begin
      ...
      pluse_level   <= pluse;
      pluse_level_1 <= pluse_level;
      pluse_level_11 <= pluse_level_1;
    end
  end
assign rise = pluse_level_1^pluse_level_11;
