...
// Pin Declarations
// -----------------------------------------------------------------------------
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         PCLK,       // APB clock
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         PRESETn,    // APB reset
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         PENABLE,    // APB enable
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire [4:2]   PADDR,      // APB address bus
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         PWRITE,     // APB write
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire [31:0]  PWDATA,     // APB write data

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         frc_sel,    // Frc register select
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         wdog_lock,  // Lock register value
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         WDOGCLK,    // Watchdog clock
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         WDOGCLKEN,  // Watchdog clock
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         WDOGRESn,   // Watchdog clock reset

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output wire         WDOGINT,    // FRC interrupt
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output wire         WDOGRES,    // FRC reset
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output reg  [31:0]  frc_data);  // Read data output
...
//------------------------------------------------------------------------------
  ...
  // Internal Signals
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          wdog_ctrl_en;     // Ctrl write enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [1:0]     wdog_control;     // Control register
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          load_en;          // Load write enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           load_en_reg;      // Registered load enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [31:0]    wdog_load;        // wdog_load regiser

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          load_tog_en;      // Enable for load request toggle
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           load_req_tog_p;   // Load request toggle, PCLK domain
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           load_req_tog_w;   // Load request toggle, WDOGCLK domain
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          load_req_w;       // Load request pulse, WDOGCLK domain

 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          count_stop;       // Halt counter
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           count_stop_reg;   // Registered count_stop

 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [15:0]    nxt_count_low;    // Count - 1 [15:0]
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [15:0]    nxt_count_high;   // Count - 1 [31:16]
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           nxt_carry_0;      // Decrement carry in
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           nxt_carry_1;      // Decrement carry in
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [1:0]    nxt_carry_mux;    // Decrement carry in (muxed)
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [1:0]     reg_carry;        // Decrement carry in
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          carry_msb;        // Multiplexed carry for 16/32-bit count
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [31:0]   count_mux1;       // Count mux value
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [31:0]   count_mux2;       // Count mux value
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [31:0]    reg_count;        // Current count
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [31:0]   count_read;       // Current count mux
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [15:0]   high_count;       // Upper half-word mux

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          wdog_int_en;      // Interrupt enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           wdog_int_en_reg;  // Registered interrupt enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          wdog_int_en_rise; // Rising edge on interrupt enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          wdog_res_en;      // Reset enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           i_wdog_res;       // Registered internal counter reset
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          nxt_wdog_res;     // Next i_wdog_res value

 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          int_clr_en;       // Interrupt clear enable
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           int_clr_tog_p;    // Int Clear toggle in PCLK domain
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           int_clr_tog_w;    // Int Clear toggle in WDOGCLK domain
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          int_clr_pulse;    // Int Clear pulse in PCLK and WDOGCLK
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          int_clr_w;        // Int Clear signal in WDOGCLK domain
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           int_clr_reg_w;    // Registered int_clr_w, WDOGCLK domain

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          nxt_wdog_ris;     // Next wdog_ris value
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           wdog_ris;        // Registered internal counter interrupt
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          read_wdog_ris;    // Registered internal counter interrupt
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          wdog_mis;        // Masked counter interrupt
