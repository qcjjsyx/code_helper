...
module cmsdk_apb_watchdog (
  ...
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         PSEL,        // APB periph select
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire [11:2]  PADDR,       // APB address bus
  ...
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         WDOGCLKEN,   // Watchdog clock enable
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire         WDOGRESn,    // Watchdog clock reset

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)input  wire  [3:0]  ECOREVNUM,   // ECO revision number

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output wire [31:0]  PRDATA,      // APB read data

  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output wire         WDOGINT,     // Watchdog interrupt
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)output wire         WDOGRES);    // Watchdog timeout reset
...
//----------------------------------------------------------------------------
  ...
  // Internal Signals
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          frc_sel;          //  FRC select (address decoding)
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire [31:0]   frc_data;         //  FRC data out
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [7:0]     wdog_pdata;       //  Peripheral/PrimeCell data out
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [31:0]    prdata_next;      //  Internal PRDATA
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [31:0]    i_prdata;         //  Registered prdata_next
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          prdata_next_en;   //  PRDATAEn register input
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          wdog_itcr_wr_en;  //  Write enable for Integration Test
                                  // Control Register
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg           wdog_itcr;        //  Integration Test Control Register
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)wire          wdog_itop_wr_en;  //  Write enable for Integration Test
                                  // Output Set Register
  (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*)reg [1:0]     wdog_itop;        //  Integration Test Output Set
                                  // Register
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*) wire          wdog_lock_wr_en;  //  Watchdog lock register write enable
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*) wire          wdog_lock_wr_val; //  Next Watchdog lock register value
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*) reg           wdog_lock;        //  Watchdog lock register
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*) wire          i_wdogint;      //  Counter interrupt
 (*KEEP="TRUE"*)(*dont_touch = "yes"*)(*OPTIMIZE="OFF"*) wire          i_wdogres;      //  Counter reset
